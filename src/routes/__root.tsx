...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Insight Stream analyzes audio/video for business insights, transcribing and interpreting content via LLM." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Insight Stream analyzes audio/video for business insights, transcribing and interpreting content via LLM." },
